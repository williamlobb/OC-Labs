...
export function ContextBlockList({ blocks, currentUserId, onEdit, onDelete }: ContextBlockListProps) {
  if (blocks.length === 0) return null

  return (
    <div className="space-y-3">
      {blocks.map((block) => {
        const isOwner = Boolean(currentUserId) && block.author_id === currentUserId
